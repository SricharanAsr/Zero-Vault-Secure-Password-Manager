            ...
            <section className="flex-1 flex items-center justify-center p-8 bg-card relative z-20">
                <div className="w-full max-w-md">
                    <div className="flex flex-col gap-6">
                        ...
                        <button onClick={onGoogleSignIn} className="animate-element animate-delay-800 w-full flex items-center justify-center gap-3 border border-border rounded-2xl py-4 hover:bg-secondary text-white font-medium transition-colors">
                            <GoogleIcon />
